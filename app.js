...
const userRatingRoutes = require('./src/routes/userRatingRoutes');
const viewingHistoryRoutes = require('./src/routes/viewingHistoryRoutes');
...
v_app.use('/api/ratings', userRatingRoutes);
v_app.use('/api/viewing-history', viewingHistoryRoutes);
...
v_app.get('/', (p_req, p_res) => {
  p_res.json({
    ...
    endpoints: {
      ...
      ratings: '/api/ratings',
      viewingHistory: '/api/viewing-history'
    }
  });
});
